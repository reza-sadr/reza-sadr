```
      ...
      .=--::::::--==--:::::::--===--------=-          Testing:        Jest / Vitest / RTL / Playwright
       ...
       .-------===+===++==+***===++=====-==:
       .---===+***++++++*@@@**++++***++====:          AI:             GenAI / LLMs / Agentic Development
        .-===+*#*##*++*+*#*******##**+++++.           AI Tools:       Cursor / Claude Code / OpenAI Codex
         .==+++****++++*******#####**++++-
          :+=+++*++++++*#####*+++++*+*++=             Experience:     Enterprise Web and Mobile Apps
           :+++*++=+====++++++=+=++*#**+              Industries:     Finance / Healthcare / Retail / SaaS
            -**+++=======+++===+++*###*:
            .=+**++++++++++++++**####*=:              Leadership:     Architecture / Standards / Mentoring
            .-=+******####@#@@@@@##*++-:              Specialty:      Offline-first / Mobile-first Apps
       ---:.::-==+**#######@@@###**+==-:-=:-
    -+#@@#=-::---==++***#######**+===--:-+@##+-       GitHub:         github.com/reza-sadr
++*#@@#@@@*-:::----===+++******+===----:-+@@@@@#*+    LinkedIn:       linkedin.com/in/reza-sadr
@@@@@#@@@@@#------====++++***+++=======-*@@@@@#@@@    Contact:        reza@reza-sadr.com
```
